                ...
                <div class="panel height2">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="bank-balance clearfix">
                            <li>Credit: 
                                <span class="text-green">$18,378</span>
                            </li>
                            <li>Debit: 
                                <span class="text-red">$12,590</span>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <ul class="stocks">
                                    <li>
                                        <p class="clearfix">Apple Inc
                                            <span>
                                                <i class="icon-triangle-up text-green"></i>465.45
                                            </span>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="clearfix">Google Inc
                                            <span>
                                                <i class="icon-triangle-up text-green"></i>821.9
                                            </span>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="clearfix">Yahoo Inc
                                            <span>
                                                <i class="icon-triangle-down text-red"></i>31.88
                                            </span>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="clearfix">Facebook Inc
                                            <span>
                                                <i class="icon-triangle-up text-green"></i>465.45
                                            </span>
                                        </p>
                                    ...
                                    <li>
                                        <p class="clearfix">Ebay Inc
                                            <span>
                                                <i class="icon-triangle-down text-red"></i>66.2
                                            </span>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="clearfix">Amazon Inc
                                            <span>
                                                <i class="icon-triangle-up text-green"></i>278.73
                                            </span>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="clearfix">Microsoft
                                            <span>
                                                <i class="icon-triangle-up text-green"></i>39.64
                                            </span>
                                        </p>
                                    </li>
                                </ul>
                        ...
                        <div class="panel height2">
                            ...
                            <div class="panel-body">
                                <ul class="app-downloads">
                                    ...
                                    <li>
                                        <p class="clearfix">
                                            <i class="icon-download5"></i>Blackberry
                                            <span>285</span>
                                        </p>
                                        <div class="progress progress-md">

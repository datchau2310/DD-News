...
<header>
	...
	<ul id="header-actions" class="clearfix">
		<li class="list-box d-lg-block d-none dropdown">
			...
			<ul class="dropdown-menu imp-notify">
				...
				<li>
					<div class="icon">
						<img src="{{asset('images/thumbs/user10.png')}}" alt="Arise Admin">
					</div>
					<div class="details">
				...
				<li>
					<div class="icon">
						<img src="{{asset('images/thumbs/user6.png')}}" alt="Arise Admin">
					</div>
					<div class="details">
				...
				<li>
					<div class="icon">
						<img src="{{asset('images/thumbs/user1.png')}}" alt="Arise Admin">
					</div>
					<div class="details">
	...
	<div class="custom-search d-lg-block d-sm-none d-none">
